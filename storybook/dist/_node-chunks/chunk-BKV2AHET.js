...
}, OpenServiceValidationError = class extends StorybookError {
  constructor(data) {
    super({
...
}, OpenServiceDuplicateRegistrationError = class extends StorybookError {
  constructor(data) {
    super({
...
}, OpenServiceMissingServiceError = class extends StorybookError {
  constructor(data) {
    super({
...
}, OpenServiceDocgenMissingComponentError = class extends StorybookError {
  constructor(data) {
    super({
...
}, OpenServiceMissingChannelError = class extends StorybookError {
  constructor(data = {}) {
    super({
...
}, NoFreePortError = class extends StorybookError {
  constructor(data) {
    super({
...
function createMinimumReleaseAgeHandledErrorMessage(data) {
  if ("message" in data)
    return data.message;
  let followUp = data.minimumReleaseAgeExclusionsConfigName ? `To fix this, either wait for the configured age window to pass and rerun the command, or add the blocked packages to ${data.packageManagerName}'s ${data.minimumReleaseAgeExclusionsConfigName} setting.` : "To fix this, either wait for the configured age window to pass and rerun the command, or rerun Storybook with an older compatible release.";
...
var MinimumReleaseAgeHandledError = class extends StorybookError {
  constructor(data) {
    super({
...
}, ViteModuleGraphSubscriptionError = class extends StorybookError {
  constructor() {
    super({

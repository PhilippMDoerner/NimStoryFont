//#region node_modules/@emotion/sheet/dist/declarations/src/index.d.ts
type Options = {
  nonce?: string;
  key: string;
  container: Node;
...
//#endregion
//#region node_modules/@emotion/utils/dist/declarations/src/types.d.ts
type RegisteredCache = Record<string, string | undefined>;
...
//#endregion
//#region node_modules/@emotion/serialize/dist/declarations/src/index.d.ts
type CSSProperties = PropertiesFallback<number | string>;
type CSSPropertiesWithMultiValues = { [K in keyof CSSProperties]: CSSProperties[K] | ReadonlyArray<Extract<CSSProperties[K], string>> };
type CSSPseudos = { [K in Pseudos]?: CSSObject };
interface ArrayCSSInterpolation extends ReadonlyArray<CSSInterpolation> {}
type InterpolationPrimitive = null | undefined | boolean | number | string | ComponentSelector | Keyframes | SerializedStyles | CSSObject;
...
interface ArrayInterpolation<Props = unknown> extends ReadonlyArray<Interpolation<Props>> {}
interface FunctionInterpolation<Props = unknown> {
  (props: Props): Interpolation<Props>;
}
type Interpolation<Props = unknown> = InterpolationPrimitive | ArrayInterpolation<Props> | FunctionInterpolation<Props>;
//#endregion
export { Interpolation as a, SerializedStyles as c, FunctionInterpolation as i, CSSObject as n, Keyframes as o, ComponentSelector as r, EmotionCache as s, CSSInterpolation as t };
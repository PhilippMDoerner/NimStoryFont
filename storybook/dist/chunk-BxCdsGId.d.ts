...
//#region node_modules/@remix-run/router/dist/history.d.ts
/**
 ...
 */
type InitialEntry = string | Partial<Location$1>;
//#endregion
//#region node_modules/@remix-run/router/dist/utils.d.ts
/**
...
type RequireOne<T, Key = keyof T> = Exclude<{ [K in keyof T]: K extends Key ? Omit<T, K> & Required<Pick<T, K>> : never }[keyof T], undefined>;
/**
...
//#endregion
//#region node_modules/@remix-run/router/dist/router.d.ts
/**
...
//#endregion
//#region node_modules/react-router/dist/lib/context.d.ts
...
//#endregion
//#region code/core/.dts-emit/code/core/src/router/utils.d.ts
interface StoryData {
  viewMode?: string;
  storyId?: string;
  refId?: string;
...
//#endregion
//#region code/core/.dts-emit/code/core/src/router/types.d.ts
...
//#endregion
export { Action as _, RenderData as a, To as b, StoryData as c, getMatch as d, parsePath as f, HydrationState as g, Navigator as h, Other as i, buildArgsParam as l, stringifyQuery as m, NavigateFunction as n, RouterData as o, queryFromLocation as p, NavigateOptions as r, DEEPLY_EQUAL as s, LinkProps as t, deepDiff as u, InitialEntry as v, Location$1 as y };
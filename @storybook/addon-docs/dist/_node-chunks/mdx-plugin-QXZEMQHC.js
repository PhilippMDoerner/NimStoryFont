...
import {
  compile
} from "./chunk-GTWZI5L5.js";
import "./chunk-RAGJXYBM.js";
import "./chunk-WI3NMAB4.js";
import {
  __commonJS,
  __toESM
...
async function mdxPlugin(options) {
  let include = /\.mdx$/, filter = createFilter(include), { presets } = options, mdxPluginOptions = (await presets.apply("options", {}))?.mdxPluginOptions, rehypeSlug = (await import("./rehype-slug-LH26LVDI.js")).default, rehypeExternalLinks = (await import("./rehype-external-links-NSKE6R2I.js")).default;
  return {

...
func dbType*(T: typedesc[SavingThrow]): string =
  "TEXT"
func dbValue*(val: SavingThrow): DbValue =
  dbValue($val)
proc to*(dbVal: DbValue, T: typedesc[SavingThrow]): T =
  parseEnum[SavingThrow](dbVal.s)
...
func dbType*(T: typedesc[SpellLevel]): string =
  "INT"
func dbValue*(val: SpellLevel): DbValue =
  dbValue(val.int)
proc to*(dbVal: DbValue, T: typedesc[SpellLevel]): T =
  SpellLevel(dbVal.i)
...
func dbType*(T: typedesc[CastingTime]): string =
  "TEXT"
func dbValue*(val: CastingTime): DbValue =
  dbValue($val)
proc to*(dbVal: DbValue, T: typedesc[CastingTime]): T =
  parseEnum[CastingTime](dbVal.s)
...
func dbType*(T: typedesc[SpellDuration]): string =
  "TEXT"
func dbValue*(val: SpellDuration): DbValue =
  dbValue($val)
proc to*(dbVal: DbValue, T: typedesc[SpellDuration]): T =
  parseEnum[SpellDuration](dbVal.s)
...
func dbType*(T: typedesc[Range]): string =
  "TEXT"
func dbValue*(val: Range): DbValue =
  dbValue($val)
proc to*(dbVal: DbValue, T: typedesc[Range]): T =
  parseEnum[Range](dbVal.s)
...
func dbType*(T: typedesc[SpellComponents]): string =
  "TEXT"
func dbValue*(val: SpellComponents): DbValue =
  dbValue($val)
proc to*(dbVal: DbValue, T: typedesc[SpellComponents]): T =
  parseEnum[SpellComponents](dbVal.s)
...
func dbType*(T: typedesc[MagicSchool]): string =
  "TEXT"
func dbValue*(val: MagicSchool): DbValue =
  dbValue($val)
proc to*(dbVal: DbValue, T: typedesc[MagicSchool]): T =
  parseEnum[MagicSchool](dbVal.s)

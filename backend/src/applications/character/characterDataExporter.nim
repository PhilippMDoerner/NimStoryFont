...
proc addCharacterListRequests(
    exportNode: var JsonNode,
    con: DbConn,
    campaignName: string,
    characters: seq[CharacterRead],
) =
  ...
  let serializedNonPlayerCharacters =
    serializedCharacters.filterIt(not it.playerCharacter)

...
implDefaults(
  OrganizationMembership, {DefaultFlag.defExported, DefaultFlag.defTypeConstr}
)

type OrganizationMembershipRead* {.
  defaults, readOnly, tableName: ORGANIZATION_CHARACTER_TABLE
.} = ref object of Model
...
implDefaults(
  OrganizationMembershipRead, {DefaultFlag.defExported, DefaultFlag.defTypeConstr}
)
...
implDefaults(
  OrganizationMemberRead, {DefaultFlag.defExported, DefaultFlag.defTypeConstr}
)

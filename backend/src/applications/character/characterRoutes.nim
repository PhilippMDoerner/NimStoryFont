...
proc addCharacterRoutes*(app: Prologue) =
  app.addRoute(
    re"/character/",
    handler = createCreateArticleHandler[CreateParams, Character, CharacterSerializable](
      serializeCharacter
    ),
    httpMethod = HttpPost,
  ...
  app.addRoute(
    re fmt"/character/pk/{ID_PATTERN}/",
    handler = createUpdateByIdHandler[UpdateParams, Character, CharacterSerializable](
      serializeCharacter
    ),
    httpMethod = HttpPut,
    middlewares = @[loginMiddleware()],
  ...
  app.addRoute(
    ...
    handler = createReadByIdHandler[
      ReadByIdParams, CharacterRead, CharacterSerializable
    ](serializeCharacterRead),
    httpMethod = HttpGet,
    middlewares = @[loginMiddleware()],
  )
  ...
  app.addRoute(
    ...
    handler = createReadCampaignListHandler[
      ReadListParams, CharacterOverview, CharacterOverviewSerializable
    ](overviewSerialize),
    httpMethod = HttpGet,
    middlewares = @[loginMiddleware()],
  )
  ...
  app.addRoute(
    ...
    handler = createReadListHandler[
      ReadListParams, CharacterOverview, CharacterOverviewSerializable
    ](getNonPlayerCharacters, checkCharacterReadListPermission, overviewSerialize),
    httpMethod = HttpGet,
    middlewares = @[loginMiddleware()],
  )
  ...
  app.addRoute(
    ...
    handler = createReadListHandler[
      ReadListParams, CharacterOverview, CharacterOverviewSerializable
    ](getPlayerCharacters, checkCharacterReadListPermission, overviewSerialize),
    httpMethod = HttpGet,
    middlewares = @[loginMiddleware()],
  )
  ...
  app.addRoute(
    ...
    handler = createReadByNameHandler[
      ReadByNameParams, CharacterRead, CharacterSerializable
    ](serializeCharacterRead),
    httpMethod = HttpGet,
    middlewares = @[loginMiddleware()],
  )
  ...
  app.addRoute(
    ...
    handler = createCreateHandler[
      CreateParams, OrganizationMembership, CharacterSerializable
    ](checkOrganizationMembershipCreatePermission, createEntry, serializeCharacter),
    httpMethod = HttpPost,
    middlewares = @[loginMiddleware()],
  )
  ...
  app.addRoute(
    re fmt"/character/organizationmemberships/pk/{ID_PATTERN}/",
    handler = createUpdateEntryByIdHandler[
      UpdateParams, OrganizationMembership, CharacterSerializable
    ](serializeCharacter),
    httpMethod = HttpPut,
    middlewares = @[loginMiddleware()],
  )

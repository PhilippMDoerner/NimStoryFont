...
proc serialize(
    entry: TimestampRead | Timestamp, sessionAudioId: int64
...
proc serializeTimestampRead*(
    connection: DbConn, entry: TimestampRead
): TimestampSerializable =
...
proc serializeTimestampReads*(
    connection: DbConn, entries: seq[TimestampRead]
): seq[TimestampSerializable] =

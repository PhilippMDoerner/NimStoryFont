...
type SerializationProc*[T: Model, M: object | ref object] =
  proc(connection: DbConn, entry: T): M {.gcsafe.}

type OverviewSerializationProc*[M: object | ref object] =
  proc(campaignName: string): seq[M] {.gcsafe.}

proc createArticle*[T: Model](
...
proc createArticle*[P: object, E: Model](
    connection: DbConn, params: P, entry: var E
): E =
...
proc readCampaignArticleList*[P: object, E: Model](
    connection: DbConn, params: P
): seq[E] =

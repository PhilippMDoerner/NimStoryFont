...
proc addSessionAudioRoutes*(app: Prologue) =
  ...
  app.addRoute(
    ...
    handler = createPatchByIdHandler[
      UpdateParams, SessionAudio, SessionAudioSerializable
    ](serializeSessionAudio),
  ...
  app.addRoute(
    ...
    handler = createReadByIdHandler[
      ReadByIdParams, SessionAudioRead, SessionAudioSerializable
  ...
  app.addRoute(
    ...
    handler = createReadListHandler[
      ReadListParams, SessionAudioRead, SessionAudioOverviewSerializable
    ](getCampaignSessionAudio, checkSessionAudioReadListPermission, overviewSerialize),
    httpMethod = HttpGet,
    middlewares = @[loginMiddleware()],
  )
  ...
  app.addRoute(
    ...
    handler = createReadHandler[
      ReadSessionAudioByParams, SessionAudioRead, SessionAudioSerializable
    ](getSessionAudioByParams, checkReadPermission, serializeSessionAudioRead),
    httpMethod = HttpGet,
    middlewares = @[loginMiddleware()],
  )

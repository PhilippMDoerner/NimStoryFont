...
proc addNodeMapRoutes*(app: Prologue) =
  ...
  app.addRoute(
    re fmt"/relationship/",
    handler =
      createCreateArticleHandler[CreateParams, CustomLink, Link](serializeCustomLink),
    httpMethod = HttpPost,
    middlewares = @[loginMiddleware()],
  )
  ...
  app.addRoute(
    re fmt"/relationship/pk/{ID_PATTERN}/",
    handler =
      createUpdateByIdHandler[UpdateParams, CustomLink, Link](serializeCustomLink),
    httpMethod = HttpPut,
    middlewares = @[loginMiddleware()],
  )
  ...
  app.addRoute(
    re fmt"/relationship/pk/{ID_PATTERN}/",
    handler =
      createPatchByIdHandler[UpdateParams, CustomLink, Link](serializeCustomLink),

...
type CreateProc*[REQUESTPARAMS: object, ENTRY: Model] =
  proc(connection: DbConn, params: REQUESTPARAMS, newEntry: var ENTRY): ENTRY

type ReadProc*[REQUESTPARAMS: object, ENTRY: Model] =
  proc(connection: DbConn, params: REQUESTPARAMS): ENTRY

type ReadListProc*[REQUESTPARAMS: object, ENTRY: Model] =
  proc(connection: DbConn, params: REQUESTPARAMS): seq[ENTRY]

type UpdateProc*[REQUESTPARAMS: object, ENTRY: Model] =
  proc(connection: DbConn, params: REQUESTPARAMS): ENTRY

type PatchProc*[REQUESTPARAMS: object, ENTRY: Model] =
  proc(connection: DbConn, params: REQUESTPARAMS, entryToPatch: ENTRY): ENTRY

type DeleteProc*[ENTRY: Model] = proc(connection: DbConn, deleteEntry: var ENTRY)

type SerializeProc*[ENTRY: Model, SERIALIZATION: object | ref object] =
  proc(connection: DbConn, entry: ENTRY): SERIALIZATION

type SerializeManyProc*[ENTRY: Model, SERIALIZATION: object | ref object] =
  proc(connection: DbConn, entries: seq[ENTRY]): seq[SERIALIZATION]
...
proc createReadByIdHandler*[P: object, E: Model, S: object | ref object](
    serialize: SerializeProc[E, S]
): HandlerAsync =
...
proc createReadByNameHandler*[P: object, E: Model, S: object | ref object](
    serialize: SerializeProc[E, S]
): HandlerAsync =
...
proc createUpdateByIdHandler*[P: object, E: Model, S: object | ref object](
    serialize: SerializeProc[E, S]
): HandlerAsync =
  const readProc: ReadProc[P, E] = readArticleById[P, E]
  ...
  result =
    createUpdateHandler[P, E, S](readProc, checkPermissionProc, updateProc, serialize)

proc createUpdateEntryByIdHandler*[P: object, E: Model, S: object | ref object](
    serialize: SerializeProc[E, S]
): HandlerAsync =
  const readProc: ReadProc[P, E] = readArticleById[P, E]
  const checkPermissionProc: CheckPermissionProc[E] = checkUpdatePermission[E]
...
proc createPatchByIdHandler*[P: object, E: Model, S: object | ref object](
  ...
  const checkPermissionProc: CheckPermissionProc[E] = checkUpdatePermission[E]
  result =
    createPatchHandler[P, E, S](readProc, checkPermissionProc, patchProc, serialize)
...
proc createCreateEntryHandler*[P: object, E: Model, S: object](
    serialize: SerializeProc[E, S]
): HandlerAsync =
...
proc createCreateArticleHandler*[P: object, E: Model, S: object | ref object](
    serialize: SerializeProc[E, S]
): HandlerAsync =
  const checkPermissionProc: CheckPermissionProc[E] = checkCreatePermission[E]

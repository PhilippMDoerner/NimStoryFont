...
import type { IAppendFileOptions, IFileHandleReadStreamOptions, IFileHandleWriteStreamOptions, IReadableWebStreamOptions, IReadFileOptions, IStatOptions, IWriteFileOptions, TWatchIgnorePattern } from './options';
...
export interface IFSWatcher extends EventEmitter {
    start(path: PathLike, persistent?: boolean, recursive?: boolean, encoding?: BufferEncoding, ignore?: TWatchIgnorePattern | TWatchIgnorePattern[]): void;
    close(): void;
    ref(): this;
    unref(): this;
}

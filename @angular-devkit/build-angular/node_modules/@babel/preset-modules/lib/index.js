...
export default declare((api, opts) => {
  ...
  return {
    plugins: [resolve("./plugins/transform-edge-default-parameters/index.js"), resolve("./plugins/transform-tagged-template-caching/index.js"), resolve("./plugins/transform-jsx-spread/index.js"), resolve("./plugins/transform-safari-for-shadowing/index.js"), resolve("./plugins/transform-safari-block-shadowing/index.js"), resolve("./plugins/transform-async-arrows-in-class/index.js"), !loose && resolve("./plugins/transform-edge-function-name/index.js"), resolve("@babel/plugin-transform-unicode-property-regex"), resolve("@babel/plugin-transform-dotall-regex")].filter(Boolean)
  };
});
...
const PASSWORD_RESET_BODY* = "Password reset was carried out as requested.\n Your new password is: {PASSWORD_PLACEHOLDER}. Please swap it out as soon as possible. \n\n Go to https://wwww.aldrune.com/wiki2 to get to the login page"

...
const PASSWORD_RESET_SUBJECT* = "Password reset of '{USERNAME}' account on nimstoryfont"
const PASSWORD_RESET_BODY* = "Password reset was carried out as requested.<br> Your new password is: {PASSWORD_PLACEHOLDER}<br><br> Click <a href='https://wwww.aldrune.com/wiki2'> here </a> to get to the login page"

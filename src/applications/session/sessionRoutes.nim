...
proc addSessionRoutes*(app: Prologue) =
    ...
    app.addRoute(
        ...
        handler = createReadCampaignListHandler[ReadListParams, SessionRead, SessionOverviewSerializable](overviewSerialize),  
        httpMethod = HttpGet,
        middlewares = @[loginMiddleware()]
    )
    ...
    app.addRoute(
        ...
        handler = createReadCampaignListHandler[ReadListParams, SessionRead, SessionSerializable](serializeSessionReads),  
        httpMethod = HttpGet,
        middlewares = @[loginMiddleware()]
    )
    ...
    app.addRoute(
        re fmt"/session/pk/{ID_PATTERN}/", 
        handler = createReadByIdHandler[ReadByIdParams, SessionRead, SessionSerializable](serializeSessionRead),  
        httpMethod = HttpGet,
        middlewares = @[loginMiddleware()]
    )
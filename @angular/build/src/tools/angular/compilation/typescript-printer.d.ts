...
export interface ExtendedPrinter extends ts.Printer {
    writeFile(sourceFile: ts.SourceFile, writer: EmitTextWriter, sourceMapGenerator?: SourceMapGenerator): void;
}
/**
...
export interface TypeScriptInternals {
    ...
    }, file: string, sourceRoot: string | undefined, sourcesDirectoryPath: string, generatorOptions: ts.CompilerOptions): SourceMapGenerator;
}
/**
 ...
 */
export declare function assertTypeScriptPrinterInternals(): void;
/**
 ...
 */
export declare function printSourceFileWithMap(sourceFile: ts.SourceFile, printer: ts.Printer, compilerHost: ts.CompilerHost, compilerOptions: ts.CompilerOptions): PrintResult;

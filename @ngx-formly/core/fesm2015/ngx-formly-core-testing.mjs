...
function createFieldComponent(field, config = {}) {
    const model = (field === null || field === void 0 ? void 0 : field.model) || {};
    const options = (field === null || field === void 0 ? void 0 : field.options) || {};
    field === null || field === void 0 ? true : delete field.model;
    field === null || field === void 0 ? true : delete field.options;
    const utils = createComponent(Object.assign(Object.assign({ template: '<formly-field [field]="field"></formly-field>', inputs: { field } }, config), { detectChanges: false }));

...
function addRouteDeclarationToNgModule(options, routingModulePath) {
    return (host) => {
        ...
        const addDeclaration = (0, ast_utils_1.addRouteDeclarationToModule)(typescript_1.default.createSourceFile(path, sourceText, typescript_1.default.ScriptTarget.Latest, true), path, buildRoute(options, options.module));
